...
- Fixed lifecycle cleanup for Ctags and linter instances so VS Code event listeners are disposed when their owning object is no longer used. [#571](https://github.com/mshr-h/vscode-verilog-hdl-support/pull/571)
- Fix Windows xvlog resolution when extensionless launcher exists. [#578](https://github.com/mshr-h/vscode-verilog-hdl-support/pull/578)
...
- Fixed incorrect syntax highlighting for regex patterns in Tcl. [#551](https://github.com/mshr-h/vscode-verilog-hdl-support/issues/551).

## [1.22.1] - 2025-12-26

### Fixed

- Fixed a bug where diagnostics are not cleared properly. [#550](https://github.com/mshr-h/vscode-verilog-hdl-support/issues/550).
...
- Added experimental `verilog.languageServer.svls.svlintTomlPath` config to override the .toml configuration file to be used by svlint.
...
- Added `verilog.ctags.enabled` setting to enable/disable Ctags integration

### Changed

- Ctags-backed features (including module instantiation) now respect the enable/disable setting
...
- Fix When running a linter through WSL, the file where the error occurred cannot be correctly indicated [#531](https://github.com/mshr-h/vscode-verilog-hdl-support/pull/531)
...
- Fix syntax highlighting for implication operator in SystemVerilog [#506](https://github.com/mshr-h/vscode-verilog-hdl-support/pull/506)
