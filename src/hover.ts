...
export class HoverProvider implements vscode.HoverProvider {
    ...
    private _findDeclaration(
        ...
        if (this.lang === 'systemverilog') { variableType = String.raw`\b(input|output|inout|reg|wire|logic|integer|bit|byte|shortint|int|longint|time|shortreal|real|double|realtime|rand|randc)\b\s+`; }
        else if (this.lang === 'verilog') { variableType = String.raw`\b(input|output|inout|reg|wire|integer|time|real)\b\s+`; }
