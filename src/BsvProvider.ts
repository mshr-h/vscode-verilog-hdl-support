...
class BsvSymbolVisior implements bsvVisitor<Boolean>{
        ...
        if (ctx.varInit.length > 0) {
            ...
            for (const id of lvalue.identifier()) {
                ...
                this.symbol_list.push(new SymbolInformation(
                    ...
                    new Location(
                        this.thisDoc,
                        new Range(new Position(id.start.line - 1, id.start.charPositionInLine), new Position(id.stop.line - 1, id.stop.charPositionInLine))
                    )
                ))
    ...
    visitBeginEndStmt_functionBodyStmt?: (ctx: BeginEndStmt_functionBodyStmtContext) => Boolean;
    visitBeginEndStmt_actionStmt?: (ctx: BeginEndStmt_actionStmtContext) => Boolean;
    visitBeginEndStmt_actionValueStmt?: (ctx: BeginEndStmt_actionValueStmtContext) => Boolean;
    visitBeginEndStmt_moduleStmt?: (ctx: BeginEndStmt_moduleStmtContext) => Boolean;
    visitBeginEndStmt_expressionStmt?: (ctx: BeginEndStmt_expressionStmtContext) => Boolean;
    ...
    visitCaseItem_functionBodyStmt?: (ctx: CaseItem_functionBodyStmtContext) => Boolean;
    visitCaseItem_actionStmt?: (ctx: CaseItem_actionStmtContext) => Boolean;
    visitCaseItem_actionValueStmt?: (ctx: CaseItem_actionValueStmtContext) => Boolean;
    visitCaseItem_moduleStmt?: (ctx: CaseItem_moduleStmtContext) => Boolean;
    visitCaseItem_expressionStmt?: (ctx: CaseItem_expressionStmtContext) => Boolean;
    visitDefaultItem_functionBodyStmt?: (ctx: DefaultItem_functionBodyStmtContext) => Boolean;
    visitDefaultItem_actionStmt?: (ctx: DefaultItem_actionStmtContext) => Boolean;
    visitDefaultItem_actionValueStmt?: (ctx: DefaultItem_actionValueStmtContext) => Boolean;
    visitDefaultItem_moduleStmt?: (ctx: DefaultItem_moduleStmtContext) => Boolean;
    visitDefaultItem_expressionStmt?: (ctx: DefaultItem_expressionStmtContext) => Boolean;
    visitWhile_functionBodyStmt?: (ctx: While_functionBodyStmtContext) => Boolean;
    ...
    visitCasePatItem_functionBodyStmt?: (ctx: CasePatItem_functionBodyStmtContext) => Boolean;
    visitCasePatItem_actionStmt?: (ctx: CasePatItem_actionStmtContext) => Boolean;
    visitCasePatItem_actionValueStmt?: (ctx: CasePatItem_actionValueStmtContext) => Boolean;
    visitCasePatItem_moduleStmt?: (ctx: CasePatItem_moduleStmtContext) => Boolean;
    visitCasePatItem_expressionStmt?: (ctx: CasePatItem_expressionStmtContext) => Boolean;
